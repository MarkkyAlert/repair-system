...
- **ผู้ใช้ 5 กลุ่ม:**
  ...
  - **หัวหน้างาน (manager)** — มอบหมาย/ย้ายงาน ดูภาพรวมทีม
...
รายการ placeholder ด้านล่างตั้งใจเว้นไว้ให้เจ้าของกรอก (Claude เดาแทนไม่ได้) — เคลียร์ให้ครบก่อนส่งมอบ:

- [ ] **[LICENSE.md](LICENSE.md)** — เติม `[ชื่อผู้ขาย / ชื่อบริษัท]`, `[ปี]`, `[อีเมล / ช่องทางติดต่อ]`
- [ ] **Support** — ระบุช่องทางซัพพอร์ต (อีเมล/LINE) และระยะเวลารับประกัน หากมี (ปัจจุบันยังเป็น `TODO`)
