...
class TicketReadRepository
{
     ...
     * index อยู่ก็ใช้ไม่ได้ กลายเป็นเรียงทั้งตารางเพื่อเอาแค่ 5 แถว. อย่ารวบกลับเป็น JOIN เดียว —
     * ไม่มีอาการตอนข้อมูลน้อย แต่ช้าขึ้นตามจำนวน ticket (query_count_test ล็อกรูปแบบนี้ไว้)
     */
     ...
     * เฉพาะ 20 แถวที่จะแสดงจริง แทนที่จะลาก 8 คอลัมน์จาก 5 ตารางไปเรียงทั้งกอง. อย่ารวบกลับเป็น JOIN เดียว —
     * รูปแบบเดิมดูสะอาดกว่าและไม่มีอาการตอนข้อมูลน้อย แต่ช้าขึ้นตามจำนวน ticket (query_count_test ล็อกไว้)
     */
