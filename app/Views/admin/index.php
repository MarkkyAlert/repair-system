<section class="stack-lg">
    ...
    <div class="stat-grid admin-stat-scroll">
        ...
        <?= render_partial('partials/components/card', ['title' => 'หมวดหมู่งาน', 'value' => (string) count($categories ?? []), 'meta' => 'ประเภทของงานแจ้งซ่อม', 'tone' => 'warning', 'icon' => 'tag', 'href' => '/admin#tab-categories', 'ariaLabel' => 'ไปที่แท็บหมวดหมู่งาน']) ?>
    ...
    <nav class="admin-tabs" role="tablist" aria-label="หมวดการตั้งค่า">
        <span class="admin-tab-grouplabel admin-tab-grouplabel-first" role="presentation" aria-hidden="true">จัดการข้อมูล</span>
        <a href="#tab-users" class="admin-tab is-active" role="tab" aria-selected="true" aria-controls="tab-users" aria-label="จัดการข้อมูล: ผู้ใช้งาน"><?= lucide('users', 'h-4 w-4') ?><span>ผู้ใช้งาน</span></a>
        ...
        <span class="admin-tab-grouplabel" role="presentation" aria-hidden="true">สิทธิ์ &amp; ตรวจสอบ</span>
        <a href="#tab-roles" class="admin-tab" role="tab" aria-selected="false" aria-controls="tab-roles" aria-label="สิทธิ์ &amp; ตรวจสอบ: สิทธิ์ตามบทบาท"><?= lucide('shield-check', 'h-4 w-4') ?><span>สิทธิ์ตามบทบาท</span></a>
        ...
        <span class="admin-tab-grouplabel" role="presentation" aria-hidden="true">ระบบ</span>
        <a href="#tab-email" class="admin-tab" role="tab" aria-selected="false" aria-controls="tab-email" aria-label="ระบบ: อีเมล"><?= lucide('send', 'h-4 w-4') ?><span>อีเมล</span></a>
