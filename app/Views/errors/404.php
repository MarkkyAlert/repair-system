<section class="error-shell">
    <div class="error-card">
        ...
        <?php $errAuthed = \App\Core\AuthManager::checkSession(); // เช็ค session แบบไม่แตะ DB (ไม่ resolve repository) หน้านี้จะได้ยังแสดงได้แม้ระบบล่ม — คนที่ล็อกอินอยู่แล้วเจอลิงก์เสีย จะพากลับหน้าแรก ไม่ใช่ไป /login ?>
