...
$glossary = [
    ...
    ['term' => '%เกิน SLA (พื้นที่ปัญหา)', 'good' => 'ยิ่งต่ำยิ่งดี',
        'def' => 'งานที่พลาดกำหนดในช่วง ÷ งานที่ตัดสินผลได้แล้ว (ทันกำหนด + พลาดกำหนด) — งานที่ยังไม่ถึงกำหนดไม่ถูกนับทั้งสองฝั่ง และถ้ายังตัดสินอะไรไม่ได้เลยจะเป็น "-" ไม่ใช่ 0%. นับงานที่พลาดกำหนดแม้ปิดไปแล้ว จึงตอบคำถามเดียวกับหน้า "SLA เกินกำหนด" และเทียบกันได้. ตัวเลขในวงเล็บข้างเปอร์เซ็นต์ = จำนวนงานที่เป็นฐาน'],
