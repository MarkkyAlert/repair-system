...
$glossary = [
    ...
    ['term' => 'ผลงานช่าง — ตัวไหนนิ่ง ตัวไหนเป็นสถานะปัจจุบัน', 'good' => '—',
        'def' => 'คอลัมน์ประเมินผลงาน (ปิดงาน · เวลาซ่อม · SLA ตรงเวลา · คะแนน) คิดจาก "งานที่ช่างคนนั้นปิดจริงในช่วง" ให้เครดิตคนกดปิด + อ่าน SLA/คะแนนจากรอบที่ปิดจริง จึง **ไม่เปลี่ยนย้อนหลัง** แม้ภายหลังมีการเปิดซ้ำ/โยกงาน และหน้าสรุปรวมกับหน้าเต็มตรงกัน. ส่วน "งานค้างปัจจุบัน · สัดส่วนโหลด · ค้างเก่าสุด · รับ" เป็น **สถานะ ณ ปัจจุบัน** (ใช้เกลี่ยงาน ไม่ใช่ประเมินย้อนหลัง). ระบบไม่แสดง "เวลาตอบรับ/ชั่วโมงแรงงาน" รายช่าง เพราะผูกกับสถานะปัจจุบัน ทำให้นิ่งย้อนหลังไม่ได้'],
