...
$glossary = [
    ...
    ['term' => 'อัตราปิดงาน (completion) — ฐานต่างกันตามหน้า', 'good' => 'ยิ่งสูงยิ่งดี',
        'def' => 'สรุปผู้บริหาร = ปิด ÷ ticket ที่แจ้งทั้งหมดในงวด (นับตามวันแจ้ง) · ผลงานทีมช่าง = ปิด ÷ (ปิด + งานค้างปัจจุบันของช่าง) — คนละตัวหาร อย่านำ % ข้ามสองหน้ามาเทียบกันตรง ๆ'],
