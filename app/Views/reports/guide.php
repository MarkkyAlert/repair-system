...
$glossary = [
    ...
    ['term' => 'อัตราปิดงาน (completion) — เฉพาะสรุปผู้บริหาร', 'good' => 'ยิ่งสูงยิ่งดี',
        'def' => 'ปิด ÷ ticket ที่แจ้งทั้งหมดในงวด (นับตามวันแจ้ง) — เป็นภาพรวมของงวด สะท้อนสถานะปัจจุบัน (งานที่เปิดซ้ำจะไม่นับว่าปิด). รายงานผลงานช่าง "ไม่มี" อัตราปิดงานรายคน เพราะตัวหาร (งานที่ช่างรับ) เปลี่ยนได้เมื่อโยกงาน/เปิดซ้ำ จึงประเมินคนย้อนหลังไม่ยุติธรรม — ดูผลงานช่างจาก "จำนวนปิดจริง + เวลาซ่อม + SLA + คะแนน" แทน'],
