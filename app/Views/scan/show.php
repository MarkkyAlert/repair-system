<section class="stack-lg">
    ...
    <section class="panel-card">
        ...
        <?php // ทรัพย์สินที่ปลดระวางแล้วรับแจ้งซ่อมไม่ได้ (ปุ่มถูกซ่อนด้านล่าง) — คำโปรยตรงนี้จึงต้องเปลี่ยนตาม
              // ไม่งั้นคนสแกนอ่านว่าเปิดงานแจ้งซ่อมได้ทันที แล้วไล่หาปุ่มที่ไม่มีอยู่ ?>
        <?php if (!empty($isReportable)): ?>
            <p class="body-text">คุณสามารถใช้ข้อมูลทรัพย์สินนี้เพื่อเปิดงานแจ้งซ่อมใหม่แบบเติมข้อมูลอัตโนมัติได้ทันที</p>
        <?php else: ?>
            <p class="body-text">ทรัพย์สินนี้ไม่เปิดรับแจ้งซ่อมแล้ว — สแกนดูข้อมูลเพื่อตรวจนับได้ตามปกติ</p>
        <?php endif; ?>
    </section>
