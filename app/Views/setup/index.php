    ...
    <div class="hero-card">
        ...
        <form class="auth-card stack-md" method="post" action="<?= e(url('/setup')) ?>" data-loading-submit>
            ...
            <label class="checkbox-row">
                ...
                <span>โหลดข้อมูลตัวอย่าง (3 แผนก, 5 สถานที่, 8 ทรัพย์สิน, 3 ช่าง, 20 Ticket ครอบหลายสถานะที่ใช้งานจริง; ไม่สร้างสถานะ closed ซึ่งเป็นค่าสำรอง) — สำหรับ dev/demo เท่านั้น ไม่ควรใช้บน production; ระบบจะสร้างบัญชีช่างตัวอย่างพร้อมรหัสสุ่มและแสดงให้ครั้งเดียว</span>
            </label>
