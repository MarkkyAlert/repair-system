...
try {
    ...
    if ($settings instanceof SettingsRepository) {
        ...
        // record notify failures so the dashboard warns + the exit code is non-zero (error-review-2 F4)
    ...
    // monitoring sees it (distinct from a crash's 1). (error-review-2 F4)
