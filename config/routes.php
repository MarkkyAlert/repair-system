...
return static function (Router $router): void {
    ...
    $router->post('/admin/users/import', [AdminController::class, 'importUsersPreview']);
    $router->post('/admin/users/import/execute', [AdminController::class, 'importUsersExecute']);
    $router->get('/admin/users/import/template.csv', [AdminController::class, 'importUsersTemplate']);
    ...
    $router->get('/admin/email-queue', [AdminController::class, 'emailQueue']);
    $router->post('/admin/email-queue/{emailId}/retry', [AdminController::class, 'retryEmailJob']);
    $router->get('/admin/email-templates', [AdminController::class, 'emailTemplates']);
    $router->get('/admin/email-templates/{templateKey}', [AdminController::class, 'emailTemplateEdit']);
    $router->post('/admin/email-templates/{templateKey}', [AdminController::class, 'emailTemplateUpdate']);
    $router->post('/admin/email-templates/{templateKey}/reset', [AdminController::class, 'emailTemplateReset']);
    ...
    $router->get('/admin/guest-requests', [AdminController::class, 'guestRequests']);
    $router->post('/admin/guest-requests/{requestId}/convert', [AdminController::class, 'convertGuestRequest']);
    $router->post('/admin/guest-requests/{requestId}/reject', [AdminController::class, 'rejectGuestRequest']);
