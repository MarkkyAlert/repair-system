...
return static function (Router $router): void {
    ...
    $router->post('/reports/asset-reliability/export/csv', [ReportsController::class, 'assetReliabilityExportCsv']);
    $router->post('/reports/asset-reliability/export/excel', [ReportsController::class, 'assetReliabilityExportExcel']);
    $router->post('/reports/asset-reliability/export/pdf', [ReportsController::class, 'assetReliabilityExportPdf']);
    $router->get('/reports/sla-breach', [ReportsController::class, 'slaBreach']);
    $router->post('/reports/sla-breach/export/csv', [ReportsController::class, 'slaBreachExportCsv']);
    $router->post('/reports/sla-breach/export/excel', [ReportsController::class, 'slaBreachExportExcel']);
    $router->post('/reports/sla-breach/export/pdf', [ReportsController::class, 'slaBreachExportPdf']);
    ...
    $router->post('/reports/trend/export/csv', [ReportsController::class, 'trendExportCsv']);
    $router->post('/reports/trend/export/excel', [ReportsController::class, 'trendExportExcel']);
    $router->post('/reports/trend/export/pdf', [ReportsController::class, 'trendExportPdf']);
    $router->get('/reports/executive', [ReportsController::class, 'executiveSummary']);
    $router->post('/reports/executive/export/csv', [ReportsController::class, 'executiveSummaryExportCsv']);
    $router->post('/reports/executive/export/excel', [ReportsController::class, 'executiveSummaryExportExcel']);
    $router->post('/reports/executive/export/pdf', [ReportsController::class, 'executiveSummaryExportPdf']);
    $router->get('/reports/backlog-aging', [ReportsController::class, 'backlogAging']);
    $router->post('/reports/backlog-aging/export/csv', [ReportsController::class, 'backlogAgingExportCsv']);
    $router->post('/reports/backlog-aging/export/excel', [ReportsController::class, 'backlogAgingExportExcel']);
    $router->post('/reports/backlog-aging/export/pdf', [ReportsController::class, 'backlogAgingExportPdf']);
    $router->get('/reports/reopen-rate', [ReportsController::class, 'reopenRate']);
    $router->post('/reports/reopen-rate/export/csv', [ReportsController::class, 'reopenRateExportCsv']);
    $router->post('/reports/reopen-rate/export/excel', [ReportsController::class, 'reopenRateExportExcel']);
    $router->post('/reports/reopen-rate/export/pdf', [ReportsController::class, 'reopenRateExportPdf']);
    $router->get('/reports/csat', [ReportsController::class, 'csat']);
    $router->post('/reports/csat/export/csv', [ReportsController::class, 'csatExportCsv']);
    $router->post('/reports/csat/export/excel', [ReportsController::class, 'csatExportExcel']);
    $router->post('/reports/csat/export/pdf', [ReportsController::class, 'csatExportPdf']);
