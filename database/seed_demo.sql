...
INSERT INTO tickets (
    ...
    (2, 'MT-20260602-0002', 'Router ห้อง Server มีอาการ packet loss', 'ผู้ใช้งานหลายแผนกแจ้งว่าเครือข่ายล่มเป็นช่วง ๆ และพบ packet loss ที่ core router', 1, 4, 2, 2, 3, 4, 2, 3, 'approved', 'in_progress', 'web', 'critical', 'critical', '2026-06-02 09:05:00', '2026-06-02 09:12:00', '2026-06-02 09:20:00', '2026-06-02 09:35:00', '2026-06-02 09:24:00', NULL, NULL, NULL, NULL, '2026-06-02 09:35:00', '2026-06-02 13:05:00', 'อยู่ระหว่างวิเคราะห์ interface uplink และตรวจสอบ firmware', NULL, NOW(), NOW()),
    (3, 'MT-20260602-0003', 'แอร์ห้องประชุมชั้น 2 ไม่เย็น', 'ห้องประชุมชั้น 2A อุณหภูมิสูงผิดปกติแม้เปิดเครื่องแล้วเกิน 30 นาที', 1, 4, 3, 3, 2, 3, 2, 3, 'approved', 'completed', 'qr', 'high', 'high', '2026-06-01 13:10:00', '2026-06-01 13:25:00', '2026-06-01 13:40:00', '2026-06-01 14:00:00', '2026-06-01 13:45:00', '2026-06-01 15:10:00', '2026-06-01 15:30:00', NULL, NULL, '2026-06-01 15:10:00', '2026-06-01 21:10:00', 'ล้างแผงคอยล์และเติมน้ำยาแอร์ ทำให้อุณหภูมิคงที่ตามปกติ', 'ผู้แจ้งยืนยันว่าห้องใช้งานได้แล้ว', NOW(), NOW());
...
INSERT INTO ticket_sla_tracks (id, ticket_id, metric_type, target_at, achieved_at, breached_at, status, created_at) VALUES
    ...
    (3, 2, 'response', '2026-06-02 09:35:00', '2026-06-02 09:24:00', NULL, 'met', NOW()),
    (4, 2, 'resolution', '2026-06-02 13:05:00', NULL, NULL, 'pending', NOW()),
    (5, 3, 'response', '2026-06-01 15:10:00', '2026-06-01 13:45:00', NULL, 'met', NOW()),
