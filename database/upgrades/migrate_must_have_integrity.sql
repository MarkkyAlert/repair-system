-- ซ่อม integrity (ความถูกต้องของข้อมูล) ที่จำเป็น สำหรับ template database ที่สร้างก่อน 2026-06-16
-- เช็กข้อมูลเดิมให้ดีก่อนรันบนฐานข้อมูลลูกค้าที่ใช้งานจริง
