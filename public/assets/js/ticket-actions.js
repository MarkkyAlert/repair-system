// ปุ่ม Action CTA (เช่น อนุมัติ/ปฏิเสธ, มอบหมาย ฯลฯ) กระโดดไปยัง section #action-*. หักลบระยะ scroll ด้วย
// ความสูงจริงของ sticky stack (topbar + .action-bar ที่ตรึงไว้) ให้กล่องเป้าหมายมาอยู่ใต้พวกมัน ไม่ถูกบัง
(function () {
    var pad = 16;
